        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="row">
              ...
              <form action="{{ route('set_factor_emergency_status') }}" method="POST">
        @csrf
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">تحديد الاحتياج للحالة الطارئة</h4>
                    <p class="card-description">تحديد الحالة الطارئة</p>
                    <div class="form-group">
                        <label for="exampleFormControlSelect1">اختار الحالة الطارئة</label>
                        <select class="form-select form-select-lg" id="exampleFormControlSelect1" name="emergency_type">
                            @foreach ($emergency_active as $key)
                                <option value="{{ $key->id }}">{{ $key->type }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputName1">الاحتياج</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="اسم الاحتياج" name="need">
                    </div>
